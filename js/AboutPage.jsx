      ...
      <Container style={{ position: "relative" }}>
        ...
        <Reveal delay={160}>
          <p style={{
            ...
            We're a Cape Town team that builds AI systems and integrates AI into the way businesses run — for South African mid-market manufacturers, retailers, and distributors. Every part of a business is an operation: finance, production, supply chain, sales. We put AI wherever it makes the business run better. We call this discipline Operational Intelligence. Start with one problem; grow from there.
          </p>
        </Reveal>
      </Container>
    </section>
